...
export default class UpdateFoodTip extends Component {
    constructor(props) {
        super(props)
        this.state = {
            wallets: [],
    ...
    componentDidMount() {
        axios.get('http://192.168.1.130:5050/wallet')
            .then(response => {
                this.setState({
    ...
    topuUpAccount = (e) => {
        ...
        if (accountBalance == "") {
            ...
            try {
                axios.post('http://192.168.1.100:5050/wallet/updateamount/' + this.state.id, updateData)
